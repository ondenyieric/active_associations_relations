...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { user1_id: @friend.user1_id, user2_id: @friend.user2_id } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { user1_id: @friend.user1_id, user2_id: @friend.user2_id } }
